...
--
-- Host: 192.168.0.4    Database: bainema
-- ------------------------------------------------------
...
CREATE TABLE `venda` (
  ...
  `Tipo` enum('Cartao','Dinheiro','Pix','Splitted','Aberto') DEFAULT NULL,
  `Total` decimal(5,2) DEFAULT NULL,
  `Total_pago` decimal(5,2) DEFAULT NULL,
...
-- Dump completed on 2022-11-14 11:26:31
